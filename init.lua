...
vim.keymap.set('n', '<leader>f', function()
  if vim.bo.filetype == 'c' or vim.bo.filetype == 'h' then
    print 'Formatting is disabled for C/ and header files!'
    return
  end
  require('conform').format { sync = true, lsp_format = 'fallback' }
...
require('lazy').setup({
  ...
  },
  {
    ...
    opts = {
      ...
      user = 'zlee', -- Your user.
      mail = 'zlee@student.42kl.edu.my', -- Your mail.
      -- add other options.
    },
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      local rose_pine = {
        ...
        insert = { a = { fg = colors.base, bg = colors.foam } },
        visual = { a = { fg = colors.base, bg = colors.iris } },
        replace = { a = { fg = colors.base, bg = colors.pine } },
        command = { a = { fg = colors.base, bg = colors.love } },
        inactive = {
